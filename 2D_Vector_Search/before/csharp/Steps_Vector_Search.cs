// Lab 2D: Vector Search - Consolidated Steps (STUDENT VERSION)
...
public class Steps_Vector_Search
{
    ...
    public async Task Step2()
    {
        ...
        // STUDENT EXERCISE: replace the placeholder query string below with a real vector-distance query.
        // See Instructions.md Step 2.
        var vectorQuery = "SELECT '(placeholder)' AS title, '(placeholder)' AS text, 0 AS score";
    ...
    public async Task Step3()
    {
        ...
        var ftsQuery = new QueryDefinition(
            "SELECT '(placeholder)' AS id, '(placeholder)' AS title, '(placeholder)' AS text WHERE 1=0")
